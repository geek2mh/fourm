...
FAE.next = function() {
  if (++FAE.index >= FAE.quota) {
    FAE.log('Uninstallation of Geek style has been completed successfully!', 'color:#8B5;font-weight:bold;');
...
FAE.error = function() {
  FAE.log('An error was encountered on step ' + FAE.index + ' (' + FAE.step[FAE.index].info + ') ERROR', 'color:#E53;font-weight:bold;');
  window.setTimeout(FAE.next, FAE.delay);
};
